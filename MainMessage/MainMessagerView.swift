...
class MainMessagerView: ObservableObject {
...
struct MainMessagesView: View {
    ...
    @ObservedObject private var vm = MainMessagerView()
        ...
        NavigationView {
            ...
            VStack {
                ...
                NavigationLink("", isActive: $shouldNavigateToChatLogView) {
                    ChatLogView(mm: chatLogViewModel)
                }
            }
            .overlay(
            ...
            ForEach(vm.recentMessage) { recentMessage in
                VStack {
                    Button {
                        ...
                        self.chatUser = .init(id: uid, uid: uid, email: recentMessage.email, imageProfile: recentMessage.imageProfile)
                        ...
                        HStack(spacing: 16) {
                            WebImage(url: URL(string: recentMessage.imageProfile))
                                .resizable()
                                .scaledToFill()
